...
oferecem uma hipótese explícita e falsificável sobre o sistema.
...
um critério objetivo para a escolha de ferramentas em projetos concretos.
...
de hexoquinase II e, em menor grau, regula a glicólise via PFK.
...
multi-ômica produz modelos com poder preditivo genuíno.
...
choque térmico --- confirmação que valida toda a estratégia de análise.
...
milhares de medidas em um único modelo coerente.
