...
\begin{equation}
|E_{\mb{ion}} = \frac{RT}{zF}\ln\frac{[\mb{ion}]_{\mb{ext}}}{[\mb{ion}]_{\mb{int}}}
|         = \frac{58\,\text{mV}}{z}\log_{10}\frac{[\mb{ion}]_{\mb{ext}}}{[\mb{ion}]_{\mb{int}}}
\end{equation}
...
\begin{tikzpicture}[
    ...
    \node[concept, fill=yellow!90, text=black, below=of rna] (cel) {Célula};

    % Fluxo principal
    \draw[->, line width=2.5pt, color=verdeescuro] (dna) -- (rna);
    \draw[->, line width=2.5pt, color=verdeescuro] (rna) -- (prot);
    \draw[->, line width=2.5pt, color=verdeescuro] (prot) -- (met);
    \draw[->, line width=2.5pt, color=verdeescuro] (met) -- (cel);

    % Retroalimentações
    \draw[->, line width=1.5pt, color=roxodna!80!black, dashed] (prot) to[bend right=55]
         node[arrow_label, above, sloped, color=verdeescuro] {Regulação} (dna);

    \draw[->, line width=1.5pt, color=azulclaro!80!black, dashed] (met) to[bend left=45]
         node[arrow_label, left, color=verdeescuro] {Feedback} (prot);

    % Saída fenotípica
    \draw[->, line width=3pt, color=verdeescuro] (cel) -- ++(-3,-2)
         node[below, font=\bfseries\large\sffamily, color=verdeescuro] {Fenótipo};
\end{tikzpicture}
...
\begin{exercicio}
A constante de Michaelis $K_M$ de uma enzima é $2\,\text{mM}$ para o substrato A e $20\,\text{mM}$ para
o substrato B. (a) Qual substrato tem maior afinidade pela enzima? (b) A concentração
intracelular típica de A é $1\,\text{mM}$ e de B é $40\,\text{mM}$. Para qual substrato a enzima opera
