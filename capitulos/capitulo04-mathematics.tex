...
\vspace{0.1cm}
\begin{center}
\begin{tikzpicture}[node distance=1.8cm, auto, scale=0.7, transform shape]
    \node[circle, draw, fill=laranjacel!20, minimum size=0.9cm] (F) {Fechado (F)};
    \node[circle, draw, fill=azulclaro!20, minimum size=0.9cm, right of=F] (A) {Aberto (A)};
    \path[->, thick, >=stealth]
