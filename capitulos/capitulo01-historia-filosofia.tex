...
\begin{frame}{O Desafio do Pensamento Sistêmico}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Aristóteles (384-322 a.C.)}
\begin{columns}
\column{0.3\textwidth}
\begin{center}
\textbf{Aristóteles}\\
...
\begin{frame}{Outras Tradições Filosóficas}
\begin{columns}
\column{0.5\textwidth}
\begin{block}{Filosofia Oriental}
\textbf{Taoísmo (China):}
\begin{itemize}
...
\column{0.5\textwidth}
\begin{block}{Filosofia Ocidental}
\textbf{Platão:}
\begin{itemize}
...
% ============================================================================
% SEÇÃO 3: BERTALANFFY E A TEORIA GERAL DOS SISTEMAS
% ============================================================================
...
\begin{frame}{Conceitos Fundamentais da TGS}
...
\begin{frame}{Crítica ao Reducionismo}
...
\begin{frame}{Cibernética: Norbert Wiener (1894-1964)}
...
\begin{frame}{Teoria da Informação: Claude Shannon (1916-2001)}
...
\begin{frame}{Teoria da Complexidade}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Sistemas Adaptativos Complexos}
...
\begin{frame}{Pioneiros da Biologia de Sistemas}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Mais Autores Modernos}
...
\begin{frame}{Abordagens Contemporâneas}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Reducionismo vs. Holismo: Uma Síntese}
...
\begin{frame}{Propriedades Emergentes}
...
\begin{frame}{Relevância para a Bioinformática}
...
\begin{frame}{Futuro da Biologia de Sistemas}
