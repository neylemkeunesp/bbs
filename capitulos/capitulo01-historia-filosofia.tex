...
\begin{frame}{Visão Aristotélica da Natureza (1/2): Quatro Causas}
...
\begin{frame}{Visão Aristotélica da Natureza (2/2): Relevância Moderna}
...
\begin{frame}[shrink=5]{René Descartes (1596-1650): O Pai da Modernidade}
\begin{columns}
\column{0.3\textwidth}
\begin{center}
...
\begin{frame}{Mais Conceitos da TGS (1/2)}
...
\begin{frame}{Mais Conceitos da TGS (2/2)}
...
\begin{frame}[allowframebreaks]{Abordagens Contemporâneas (1/2)}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}[allowframebreaks]{Abordagens Contemporâneas (2/2)}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Desafios Atuais (1/2): Técnicos}
...
\begin{frame}{Desafios Atuais (2/2): Conceituais}
...
\begin{frame}[shrink=5]{Mensagem Final}
