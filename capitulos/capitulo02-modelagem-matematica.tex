...
\begin{tikzpicture}[node distance=2.5cm, auto,
    ...
    \node[box, below of=modelo] (analise) {Analise\\Computacional};
...
\begin{frame}{Analise de Sensibilidade}
...
\begin{frame}{Tipos de Analise de Sensibilidade}
\begin{block}{Local}
\begin{itemize}
...
\begin{frame}[fragile]{Analise de Sensibilidade Local}
...
\begin{frame}{Numero Básico de Reprodução}
...
\begin{frame}[fragile]{Analise e Visualização}
\begin{lstlisting}[language=Python, caption=Analise do modelo SIR]
S, I, R = sol.T
