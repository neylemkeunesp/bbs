% ============================================================================
% CAPÍTULO 0: FERRAMENTAS COMPUTACIONAIS PARA BIOLOGIA DE SISTEMAS
% Bioinformática para Biologia de Sistemas
% ============================================================================

\input{../template/beamer-template.tex}

\title[Cap. 0: Ferramentas Computacionais]{Capítulo 0: Ferramentas Computacionais para Biologia de Sistemas}
...
% ============================================================================
% SEÇÃO 2: TERMINAL E LINHA DE COMANDO
% ============================================================================
...
\begin{tikzpicture}[node distance=1.3cm, every node/.style={font=\footnotesize}]
    \node[draw, fill=azulescuro!20, rounded corners, minimum width=1.8cm] (fastq) {FASTQ bruto};
    \node[draw, fill=azulclaro!20, rounded corners, minimum width=1.8cm, right=of fastq] (qc) {FastQC};
    \node[draw, fill=verdeacido!20, rounded corners, minimum width=1.8cm, right=of qc] (trim) {Trimmomatic};
    \node[draw, fill=laranjacel!20, rounded corners, minimum width=1.8cm, right=of trim] (align) {STAR / HISAT2};
    \node[draw, fill=roxodna!20, rounded corners, minimum width=1.8cm, right=of align] (count) {featureCounts};
    \node[draw, fill=azulescuro!20, rounded corners, minimum width=1.8cm, below=of count] (deseq) {DESeq2};
    \node[draw, fill=verdeacido!20, rounded corners, minimum width=1.8cm, left=of deseq] (enrich) {Enriquecimento};
    \node[draw, fill=laranjacel!20, rounded corners, minimum width=1.8cm, left=of enrich] (viz) {Visualização};
