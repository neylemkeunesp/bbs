...
\begin{tikzpicture}[scale=0.7]
    ...
    \begin{scope}[xshift=3cm]
        \draw[thick, azulescuro, decorate, decoration={coil, aspect=0.5, segment length=3mm, amplitude=2mm}] (0,0) -- (2,0);
...
\begin{tikzpicture}[scale=0.65]
    ...
    \begin{scope}[yshift=-3cm]
        % Helix-turn-helix
        \draw[thick, verdeacido, decorate, decoration={coil, aspect=0.5, segment length=2mm, amplitude=1.5mm}] (0,0) -- (1.5,0);
        \draw[thick, azulescuro] (1.5,0) to [out=45, in=180] (2,0.5);
        \draw[thick, laranjacel, decorate, decoration={coil, aspect=0.5, segment length=2mm, amplitude=1.5mm}] (2,0.5) -- (3.5,0.5);
