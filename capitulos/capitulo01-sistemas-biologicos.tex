...
\begin{frame}[fragile]{Predição de Estrutura Secundária do RNA: Pseudocódigo}
...
\begin{frame}{Aminoácidos: Classificação}
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}{Estrutura Secundária: Folhas $\beta$}
\begin{columns}
\column{0.5\textwidth}
